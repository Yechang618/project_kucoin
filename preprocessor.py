...
if __name__ == "__main__":
    ...
    df = generate_df(symbols)
    print(df.head(5))
    print(df.info())
    df.to_csv('basis_5_2025-05-22.csv', index=True, header=True, quoting=csv.QUOTE_NONNUMERIC)
    print("DataFrame saved to 'basis_5_2025-05-22.csv'")
