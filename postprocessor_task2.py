...
quote = "USDT"
pair = f"{symbol}{quote}"
processed_dir, output_dir = Path("datasets/task2/training"), Path("datasets/kronos_task2_train")
# processed_dir, output_dir = Path("datasets/task2/testing"), Path("datasets/kronos_task2_test")
...
# 保存为 Kronos 格式
output_file = output_dir / f"{pair}_task2.csv"
